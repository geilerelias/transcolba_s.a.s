    ...
    <body>
        ...
        <div>
            <ul class="nav nav-bg-transcolba" >
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-transcolba "  href="#">Registrar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-transcolba active-secundary-transcolba" href="componente-modificar.html">Modificar</a>
                </li>
                <li class="nav-item">
