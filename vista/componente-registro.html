    ...
    <body>
                ...
                <div class="navbar navbar-light bg-faded shadow row" id="navbar" data-spy="affix" data-offset-top="197" style="background-color: #0074c0;">
                    ...
                    <div class="d-none d-sm-block row justify-content-center ">
                        ...
                        <li class="nav-item text-white">
                            <a class="nav-link text-white text-capitalize nav-active-transcolba" href="componentes-opciones.html">Componentes</a>
                        </li>
                        <li class="nav-item text-white">
        ...
        <div>
            <ul class="nav nav-bg-transcolba" >
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-transcolba active-secundary-transcolba"  href="#">Registrar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-transcolba" href="componente-modificar.html">Modificar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  text-capitalize text-transcolba" href="componente-consultar.html">Consultar</a>
                </li>
            </ul>
        </div>
                ...
                <div class="col-md-6 col-sm-6 ">
                    <form action="Maquina" method="get" accept-charset="utf-8">
                        <div class=" card encabezado " style="z-index: 0">
                            <div class="title" style="background-image: url(../assets/img/componentes/bg-repuesto.jpg);">
                                <span class="title-1">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group">
                                            <label for="input-nombre" class="bmd-label-floating">Nombre</label>
                                            <input type="text" class="form-control" id="input-nombre" name="input-nombre" required aria-required="true">
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                        <div class="form-group ">
                                            <label for="input-marca" class="bmd-label-floating"> Descripcion</label>
                                            <input type="text" class="form-control" id="input-marca" required  name="input-marca" aria-required="true" >
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                        <div class="form-group bmd-form-group">
                                            <label for="input-linea" class="bmd-label-floating">Referencia</label>
