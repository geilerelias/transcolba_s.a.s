        ...
        <div class="bmd-layout-container bmd-drawer-f-l bmd-drawer-overlay">
                    ...
                    <div class="d-none d-sm-block row justify-content-center ">
                        <ul class="nav col-12">
                            <ul class="nav col-12">
                                ...
                                <li class="nav-item " >
                                    <a class="nav-link text-white text-capitalize nav-active-transcolba" href="#">Maquinaria</a>
                                </li>
                            </li>
            ...
            <div>
                <ul class="nav nav-bg-transcolba" >
                    <li class="nav-item">
                        <a class="nav-link text-capitalize text-transcolba "  href="maquinaria-registro.html">Registrar</a>
                    </li>
                    <li class="nav-item">
            ...
            <!------------------- FIN CABECERA----------------------------------->
            <!------CONTENIDO--------------->
            <img src="../assets/img/bg-maquinaria.jpg" class="img-fluid w-100" alt="Responsive image">
        </div>
                ...
                <div class="container pt-2">
                    <div class="row ">
                        <div class="col-8 col-sm-4 text-center">
                            <div class="pb-3">
                                <img class="rounded-circle img-fluid w-50" src="../assets/img/iconos/icon-registrar-maquinaria.png" alt="Generic placeholder image">
                                <p>
                                    En esta sesión podra hacer el registro de las maquinas y equipos automotrices.
                                </p>
                            </div>
                            <div class="pb-5">
                                <a class="btn-link text-info pb-5" href="maquinaria-registro.html" >Registrar »</a>
                            </div>
                        </div>
                        <!-- /.col-lg-4 -->
                        <div class="col-8 col-sm-4 text-center">
                            <div class="pb-3">
                                <img class="rounded-circle img-fluid w-50" src="../assets/img/iconos/icon-modificar-maquinaria.png" alt="Generic placeholder image">
                                <p class="text-justify">
                                    En esta sesión podra hacer las modificaciones respectivas.
                                </p>
                            </div>
                            <div class="pb-5">
                                <a class="btn-link text-info pb-5" href="maquinaria-modificar.html" >Modificar »</a>
                            </div>
                        ...
                        <div class="pb-3">
                            <img class="rounded-circle img-fluid w-50" src="../assets/img/iconos/icon-eliminar-maquinaria.png" alt="Generic placeholder image">
                            <p>
                                Con esta sesión podrá eliminar de su registro cualquiera de las maquinas y equipos.
                            </p>
                        </div>
                        <div class="pb-5">
                            <a class="btn-link text-info pb-5" href="" >Eliminar »</a>
                        </div>
                    ...
                    <div class="col-8 col-sm-4 text-center">
                        <div class="pb-3">
                            <img class="rounded-circle img-fluid w-50" src="../assets/img/iconos/icon-consultar-maquinaria.png" alt="Generic placeholder image">
                            <p class=" text-justify">
                                En esta sesión podra realizar desde unas consulta individual hasta una general de todos sus registros de maquinas y equipos automotrices.
                            </p>
                        </div>
                        <div class="pb-5" >
                            <a class="btn-link text-info pb-lg-5" href="maquinaria-consultar.html" >Consultar »</a>
                        </div>
