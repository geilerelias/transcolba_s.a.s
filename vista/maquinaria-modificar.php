    ...
    <body>
        ...
        <div>
            <ul class="nav nav-bg-transcolba" >
                ...
                <li class="nav-item">
                    <a class="nav-link text-capitalize text-transcolba active-secundary-transcolba" href="maquinaria-modificar.html">Modificar</a>
                </li>
                <li class="nav-item">
...
$result = mysqli_query($mysqli, " SELECT * FROM maquinaria WHERE placa=$placa");
        ...
        <div class="container pt-5 mt-5">
            <div class="row justify-content-center">
                <div class="col-md-9 col-sm-6">
                    <form action="../includes/maquinaria-modificar.php" method="POST" accept-charset="utf-8">
                        <div class=" card encabezado" style="z-index: 0">
                                ...
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="input-placa" name="input-placa" disabled aria-required="true">
                                        </div>
                                    </div>
                                    <div class="col-sm">
                                        <div class="form-group ">
                            ...
                            <div class="card-footer text-right">
                                <button type="submit" name="btn-modificar" class="btn btn-raised btn-info">Modificar</button>
                            </div>
                        </div>
                    </form>
                </div>
