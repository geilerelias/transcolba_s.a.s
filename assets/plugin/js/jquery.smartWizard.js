...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setElements: function () {
            ...
            this.main.addClass('sw-main shadow-lg p-3 mb-5 bg-white rounded sw-theme-' + this.options.theme);
            // Set anchor elements
            this.nav.addClass('nav nav-tabs step-anchor bg-white').children('li').addClass('nav-item').children('a').addClass('nav-link'); // nav-justified  nav-pills
            ...
            this.container.addClass('sw-container tab-content card-body');
            // Set content pages
        ...
        _setToolbar: function () {
            ...
            var btnPreviousDiv = $('<div></div>').addClass('mr-auto').append(btnPrevious);


            var btnGroup = $('<div></div>').addClass('card-footer bg-white row').append(btnPreviousDiv, btnNextDiv);
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('<div></div>').addClass("container-fluid");
        ...
        _setButtons: function (idx) {
            ...
            if (!this.options.cycleSteps) {
                if (0 >= idx) {
                    $('.sw-btn-prev', this.main).addClass("d-none");
                } else {
                    $('.sw-btn-prev', this.main).removeClass("d-none");
                }
                if (this.steps.length - 1 <= idx) {
                    $('.sw-btn-next', this.main).addClass("d-none");
                    $('.sw-btn-finish', this.main).removeClass("d-none");
                } else {
                    $('.sw-btn-next', this.main).removeClass("d-none");
                    $('.sw-btn-finish', this.main).addClass("d-none");
                }
            }
            return true;
        },
