...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2018 a las 15:48:17
...
CREATE TABLE `incidencia` (
  ...
  `nombre` varchar(30) DEFAULT NULL,
  `descripcion` varchar(30) DEFAULT NULL,
  `codigo_maquinaria` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `maquinaria` (
  ...
  `modelo` varchar(10) NOT NULL DEFAULT 'activa',
  `linea` varchar(10) NOT NULL,
  `color` varchar(10) NOT NULL,
  `fecha_adquicision` varchar(30) NOT NULL,
...
--
-- Estructura de tabla para la tabla `suministro_combustible`
--

CREATE TABLE `suministro_combustible` (
  `id` int(11) NOT NULL,
  `codigo_maquinaria` varchar(30) DEFAULT NULL,
  `cantidad` varchar(30) DEFAULT NULL,
  `precio` varchar(50) DEFAULT NULL,
  `tipo` varchar(10) DEFAULT NULL,
  `odometraje` varchar(10) NOT NULL,
...
CREATE TABLE `usuario` (
  ...
  `mucipio` varchar(50) NOT NULL,
  `direccion` varchar(50) NOT NULL,
  `telefono` varchar(50) NOT NULL,
  `nombre_usuario` varchar(50) NOT NULL,
  `constraseña` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `usuario` (`cedula`, `nombres`, `apellidos`, `fecha_nacimiento`, `mucipio`, `direccion`, `telefono`, `nombre_usuario`, `constraseña`) VALUES
('', '', '', '', '', '', '', '', '');
